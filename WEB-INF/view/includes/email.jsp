...
<div id="email" class="d-none">
	...
	<div class="form-group">
		...
		<div class="form-check form-check-inline">
			...
			<input name="setup"  class="form-check-input" type="radio" value="No">
	...
	<div class="form-group">
		...
		<div class="form-check form-check-inline">
			...
			<input name="signIn"  class="form-check-input" type="radio" value="No">
	...
	<div class="form-group">
		...
		<div class="form-check form-check-inline">
			...
			<input name="sendAndReceive"  class="form-check-input" type="radio" value="No">
			<label class="form-check-label" for="sendAndReceive">
				No
			</label>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="form-check form-check-inline">
			...
			<input name="internet"  class="form-check-input" type="radio" value="No">
